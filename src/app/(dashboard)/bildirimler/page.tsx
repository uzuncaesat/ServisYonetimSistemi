  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <PageHeader
          title="Bildirimler"
          description={data?.unreadCount ? `${data.unreadCount} okunmamış bildirim` : "Tüm bildirimler okundu"}
        />
        {data?.unreadCount ? (
          <Button
            variant="outline"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {!notification.read && (
                          <Badge variant="default" className="text-[10px] px-1.5 py-0 bg-blue-500">
                            Yeni
                          </Badge>
                        )}
                      </div>
